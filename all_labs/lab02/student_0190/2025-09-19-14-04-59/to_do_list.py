...
def add_task(to_do_list, activity):
    to_do_list.append(activity)
    count = len(to_do_list)
    return ("Task successfully added. " + str(count) + " tasks remaining.")


def delete_task(to_do_list, activity):
        to_do_list.remove(activity)
        count = len(to_do_list)
        return ("Task successfully deleted. " + str(count) + " tasks remaining.")
...
to_do_list = ["Buy groceries", "Clean the house", "Walk the dog"]
result = delete_task(to_do_list, "Clean the house")
print(result)  
...
#print(delete_task(["Buy groceries", "Clean the house", "Finish homework"], "Clean the house"))
#print(delete_task(['Task 1', 'Task 2', 'Task 3'], 'Task 2') )
...
#print('Current to-do list:', to_do_list, '\n')
#print(move_task(['Buy groceries', 'Clean room', 'Finish homework'], 1, 2))