...
print(add_task(to_do_list, "go sleep"))
print(add_task(to_do_list, "go run"))
print(add_task(to_do_list, "go to class"))
print(add_task(to_do_list, "go walk"))
print(add_task(to_do_list, "go do homework"))
print(add_task(to_do_list, "go study"))

def delete_task(to_do_list, task):
  to_do_list.remove(task)
  return ("Task successfully deleted. " + str(len(to_do_list)) + " tasks remaining.")
print(delete_task(to_do_list, "go run"))
print(delete_task(to_do_list, "go sleep"))

def move_task(to_do_list, from_index, to_index):
  to_do_list.pop(0)
  return ("Task " + str((to_do_list)) + " successfully moved to index n")
