...
print(add_task(to_do_list, "play fortnite"))
print(add_task(to_do_list, "read"))
...
print(delete_task(to_do_list, "play fortnite"))

def move_task(a, b, c):
  task = a.pop(b)
  a.insert(c, task)
  return "Task " + "'" + task + "'" + " successfully moved to index " + str(c)
