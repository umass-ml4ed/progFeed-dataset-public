...
def add_task(activity_list, activity):
  activity_list.append(activity)
  return f"Task successfully added. {len(activity_list)} tasks remaining."

def delete_task(to_do_list, activity_to_remove):
  to_do_list.remove(activity_to_remove)
