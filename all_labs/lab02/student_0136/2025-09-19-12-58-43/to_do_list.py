...
def add_task(to_do_list, task):
  ...
  acknowledgement = "Task successfully added. " + str(len(to_do_list)) + " tasks remaining."
  return acknowledgement

def delete_task(to_do_list, task):
  to_do_list.remove(task)
  acknowledgement = "Task successfully deleted. " + str(len(to_do_list)) + " tasks remaining."
  return acknowledgement
