...
def add_task(list,task):
  list.append(task)
  return "Task successfully added.",str(len(list)),"tasks remain."

def delete_task(list,task):
  list.remove(task)
  return "Task successfully completed.",str(len(list)),"tasks remain."
...
def move_task(list,from_index,to_index):
  ...
  T=a
  J=to_index
  return "Task",T,"successfully moved to index",J
