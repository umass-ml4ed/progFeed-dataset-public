...
def add_task(a,b):
  to_do_list.append(b)
  return "Task successfully added! You have",len(to_do_list),"tasks remaining."

def delete_task(a,b):
  to_do_list.remove(b)
  return "Task successfully completed! You have",len(to_do_list),"tasks remaining."

def move_task(a,from_index,to_index):
  T=to_do_list[from_index]
  J=to_do_list[to_index]
  to_do_list.insert(from_index,to_index)
  to_do_list.pop(from_index)
  return "Task",T,"sucessfully moved to index", J
