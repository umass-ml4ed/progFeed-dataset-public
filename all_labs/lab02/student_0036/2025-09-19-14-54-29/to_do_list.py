...
def add_task(list,task):
  list.append(task)
  return "Task successfully added! You have",len(list),"tasks remaining."

def delete_task(list,task):
  list.remove(task)
  return "Task successfully completed! You have",len(list),"tasks remaining."

def move_task(list,from_index,to_index):
  b=list.pop(from_index,to_index)
