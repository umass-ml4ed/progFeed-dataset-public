...
def add_task(list,task):
  list.append(task)
  return print("Task successfully added.",str(len(list)),"tasks remaining.")

def delete_task(list,task):
  list.remove(task)
  return print("Task successfully completed.",str(len(list)),"tasks remaining.")
...
def move_task(list,from_index,to_index):
  ...
  T=a
  J=to_index
  return print("Task",T,"successfully moved to index",J)
