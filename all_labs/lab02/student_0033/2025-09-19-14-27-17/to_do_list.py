...
ef add_task(to_do_list,task):
    to_do_list.append(task)
    print ("Task successfully added.",len(to_do_list),"tasks remaniing.")
add_task(to_do_list,"Complete the assignment")

def delete_task(to_do_list,task):
    to_do_list.remove(task)
    print("Task successfully deleted.",len(to_do_list),"tasks remaining.")
delete_task(to_do_list,"Complete the assignment")

def move_task(to_do_list,from_index,to_index):
    task=to_do_list.pop(from_index)
    to_do_list.insert(to_index,task)
    return "Task",task,"successfully moved","to index",to_index
