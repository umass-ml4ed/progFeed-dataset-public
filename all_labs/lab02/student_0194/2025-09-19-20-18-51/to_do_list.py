...
def add_task(list, string):
  list.append(string)
  print("Task successfully added. " + str(len(list)) + " tasks remaining.")
  return list

def delete_task(list, string):
  list.remove(string)
  print("Task successfully deleted. " + str(len(list)) + " tasks remaining.")
  return list
...
def move_task(list, findex, tindex):
  ...
  print("Task " + str(a) + "successfully moved to index " + str(tindex))
  return list
