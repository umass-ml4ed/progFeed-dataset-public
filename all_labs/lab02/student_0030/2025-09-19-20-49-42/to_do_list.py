...
def add_task(to_do_list, task):
  ...
  return "Task successfully added. "+ str(len(task))+ " tasks remaining."

def delete_task(to_do_list, task):
 to_do_list.remove(task)
 return "Task successfully deleted. "+ str(len(task))+ " tasks remaining."

def move_task(to_do_list, from_index, to_index):
  task = to_do_list.pop(from_index)
  to_do_list.insert(to_index, task)
  return "Task successfully " + "\'"+ str(to_do_list[from_index]) + "\'" + " successfully moved to index " + str(to_index)
