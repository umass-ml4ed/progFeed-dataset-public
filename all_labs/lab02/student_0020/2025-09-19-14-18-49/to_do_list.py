...
def add_task(lis, task):
  lis.append(task)
  return "Task successfully added. " + str(len(lis)) + " tasks remaining."

def delete_task(lis, task):
  lis.remove(task)
  return "Task successfully deleted. " + str(len(lis)) + " tasks remaining."

def move_task(lis,a,b):
  item=lis.pop(a)
  lis.insert(b,item)
  return "Task \'" + item + "\' successfully moved to index " + str(b)
