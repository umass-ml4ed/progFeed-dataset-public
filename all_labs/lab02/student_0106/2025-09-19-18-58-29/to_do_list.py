...
def add_task(a, b):
  a.append(b)
  message = "Task successfully added. " + str(len(a))  + " tasks remaining."
  return message

def delete_task(a, b):
  a.remove(b)
  message = "Task successfully deleted. " + str(len(a))  + " tasks remaining."
  return message
...
def move_task(a, b, c):
  ...
  a.pop(b)
  a.insert(c, item)
  message = "Task \'" + item + "\' successfully moved to index " + str(c)
  return message
# ===== YOUR CODE ENDS HERE =====
