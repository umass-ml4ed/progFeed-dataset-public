...
# Move a task
def move_task(list_to_do, from_index, to_index):
    if 0 <= from_index < len(list_to_do) and 0 <= to_index < len(list_to_do):
        task = list_to_do.pop(from_index)
        list_to_do.insert(to_index, task)
