...
def add_task(a,b):
  a.append(b)
  return "Task successfully added. "+str(len(a))+" tasks remaining."

def delete_task(a,b):
  a.remove(b)
  return "Task successfully deleted. "+str(len(a))+" tasks remaining."

def move_task(a,from_index,to_index):
  d = a[from_index]
  a.pop(from_index)
  a.insert(to_index,d)
  return "Task '"+ str(d) + "' successfully moved to index "+  str(to_index)
