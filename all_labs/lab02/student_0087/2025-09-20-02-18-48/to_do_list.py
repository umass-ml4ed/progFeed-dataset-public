...
def move_task(to_do_list, from_index, to_index):
  part_1 = (to_do_list [from_index])
  pop_lis = to_do_list.pop(from_index)
  put_back_lis = to_do_list.insert(to_index, pop_lis)
  return ("Task '" + part_1 + "' successfully moved to index " + str(to_index))
  return (to_do_list)
# ===== YOUR CODE ENDS HERE =====
