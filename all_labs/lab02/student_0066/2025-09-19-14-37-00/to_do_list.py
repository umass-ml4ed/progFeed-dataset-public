...
def add_task(lst: list, task: str):
  lst.append(task)
  return "Task succesfully added. " + str(len(lst)) + " tasks remaining."

def delete_task(lst: list, task: str):
  lst.remove(task)
  return "Task succesfully removed. " + str(len(lst)) + " tasks remaining."

def move_task(lst: list, from_index: int, to_index: int):
  lst[from_index], lst[to_index] = lst[to_index], lst[from_index]
