...
def add_task(task_list,task):
  ...
  return("Task successfully added. " + str(len(task_list)) + " tasks remaining.")
print(add_task(to_do_list, 'zybook reading'))
print(add_task(to_do_list, 'do laundry'))
print(add_task(to_do_list, 'cics110 lab 3'))
print(add_task(to_do_list, 'cics110 lab 4'))
print(add_task(to_do_list, 'cics110 lab 6'))

def delete_task(task_list,task):
  task_list.remove(task)
  return("Task successfully deleted. " + str(len(task_list)) + " tasks remaining.") 
print(delete_task(to_do_list, 'do laundry'))

def move_task(task_list,from_index,to_index):
  task=task_list[from_index]
  task_list.pop(from_index)
  task_list.insert(to_index, task)
  return("Task " +str(task)+" sucessfully moved to index "+ str(to_index))
