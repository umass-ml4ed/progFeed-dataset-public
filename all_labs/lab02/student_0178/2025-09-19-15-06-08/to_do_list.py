...
def move_task(task_list,from_index,to_index):
  element=task_list[from_index]
  task_list.remove(task_list[from_index])
  task_list.insert(to_index,element)
  return "Task '"+str(element)+"' successfully moved to index "+str(to_index)
