...
def add_task(list1,object1):
  list1.append(object1)
  n = len(list1)
  return "Task successfully added. "+str(n)+" tasks remaining."

def delete_task(list2,object2):
  list2.remove(object2)
  n = len(list2)
  return "Task successfully delted. "+str(n)+" tasks remaining."

def move_task(list3,from_i,to_i):
  a = list3.pop(from_i)
  list3.insert(to_i,a)
  return "Task "+str(a)+" successfully moved to index "+str(to_i)
