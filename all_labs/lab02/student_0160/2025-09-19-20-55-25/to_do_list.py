...
def delete_task(list, y):
  list.remove(y)
  return ("Task successfully deleted. " + str(len(list)) + " tasks remaining.")

def move_task(list, from_index, to_index):
  a = list.pop(from_index)
  list.insert(to_index, a)
  return ("Task '" + str(a) + "' successfully moved to index " + str(to_index))
...
#print(move_task(to_do_list, 1, 3))
#print('Current to-do list:', to_do_list, '\n')
