...
def  B(input("Description of task_")):
  a = input("description of task_")
...
def delete_task(to_do_list , a ):
  to_do_list.remove(a)
  print((to_do_list, "was successfully completed"))

def move_task(to_do_list, from_index ,to_index):
  from_index.move(to_index)
  print((move_task)(to_do_list, ))

if move_task = (to_do_list, from_index , to_index) = 
  print("T")
