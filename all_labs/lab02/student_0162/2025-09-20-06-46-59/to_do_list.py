...
def add_task(to_do_list, AddTaskDescription):
  to_do_list.append(AddTaskDescription)
  length = len(to_do_list)
  print("Task successfully added.", length," tasks remaining")

def delete_task(to_do_list, DeleteTaskDescription):
  to_do_list.remove(DeleteTaskDescription)
  length = len(to_do_list)
  print("Task successfully deleted.", length," tasks remaining")
