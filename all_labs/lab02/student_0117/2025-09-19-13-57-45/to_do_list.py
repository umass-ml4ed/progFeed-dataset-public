...
def add_task(which_task_being_added: list, description_of_task: str):
  which_task_being_added = which_task_being_added.append(str(description_of_task))
...
def delete_task(task_being_modified: list, desciption_of_the_task: str):
  task_being_modified = task_being_modified.pop(task_being_modified.index(str(desciption_of_the_task)))
  return "Task successfully added. " + str(len(to_do_list)) + " tasks remaining."
...
def move_task(task_that_will_modified: list, from_index: int, to_index: int):
  ...
  return ("Task " + str(popped_item) + " successfully moved to index " + str(to_index))
