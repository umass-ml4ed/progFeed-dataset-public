...
def move_task(list, from_index, to_index):
  from_index = list.pop(from_index)
  list.insert(to_index, from_index)
  return f"Task {str(from_index)} succesfully moved to index {to_index}"
# ===== YOUR CODE ENDS HERE =====
...
print('Current to-do list:', to_do_list, '\n')
list_is = ['Buy groceries', 'Clean the house', 'Finish homework']
print(move_task(list_is, 1, 0))
print(list_is)
