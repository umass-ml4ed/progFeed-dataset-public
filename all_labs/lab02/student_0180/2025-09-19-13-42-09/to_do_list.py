...
def move_task(l, from_index, to_index):
  moved_element = l[from_index]
  l.pop(from_index)
  l.insert(to_index, moved_element)
  return "Task " + " '" + str(moved_element) + "' " + " successfully moved to index " + str(to_index)
