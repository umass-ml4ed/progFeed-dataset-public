...
print(add_task(to_do_list, 'write a letter'))
...
def delete_task(to_do_list, task):
  ...
  return f"Task successfully deleted. {len(to_do_list)} task remaining"
print(delete_task(to_do_list, 'write a letter'))
...
def move_task(to_do_list, from_index, to_index): 
  ...
  return f"Task 'write a letter' sucessfully moved to index {to_index}"

to_do_list = ['write a letter,' 'give a mouse a cookie,' 'add two and three']
