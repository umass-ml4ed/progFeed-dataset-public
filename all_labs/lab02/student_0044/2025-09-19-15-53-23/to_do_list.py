...
def delete_task(to_do_list, task):
  ...
  (len(to_do_list))
  return(f"Task successfully removed. {len(to_do_list)} tasks remaining.")
...
def move_task(to_do_list, from_index, to_index):
  ...
  return(f"Task '{t}' successfully moved to index {to_index}")

#['sleep', 'do laundry', 'cics110 lab 3', 'grocery shopping']
