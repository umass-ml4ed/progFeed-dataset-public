...
def add_task(to_do_list, str):
  to_do_list.append(str)
  return print('\nTask successfully added.', len(to_do_list), 'tasks remaining.')

def delete_task(to_do_list, str):
  to_do_list.remove(str)
  return print("\nTask successfully deleted.", len(to_do_list), "tasks remaining.")

def move_task(to_do_list, from_index, to_index):
  poppy = to_do_list.pop(from_index)
  to_do_list.insert(to_index, poppy)
  return print("\nTask", to_do_list[to_index], "successfully moved to index", str(to_index))
