...
def add_task(to_do_list, _my_string):
  to_do_list.append(_my_string)
  return 'Task successfully added. '+ str(len(to_do_list)) + ' tasks remaining.'

def delete_task(to_do_list, _my_string):
  to_do_list.remove(_my_string)
...
#def move_task(to_do_list, from_index, to_index):
  ...
  #return 'Task', to_do_list[from_index], 'successfully moved to index', to_index
