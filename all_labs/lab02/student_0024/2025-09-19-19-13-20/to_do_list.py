...
def add_task(to_do_list, taskadd):
  ...
  return "Task successfully added." ,counter1, "tasks remaining."

def delete_task(to_do_list, taskdel):
  global counter2
  counter2 = counter2 + 1
  to_do_list.remove(taskdel)
  return "Task successfully deleted." ,counter2, "tasks remaining."

def move_task(to_do_list, from_index, to_index):
  to_do_list.insert(to_index, to_do_list[from_index])
  return "Task" ,to_do_list[from_index], "successfully moved to" ,to_index
