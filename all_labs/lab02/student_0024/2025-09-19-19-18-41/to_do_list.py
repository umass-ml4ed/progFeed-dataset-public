...
def add_task(to_do_list, taskadd):
  ...
  return "Task successfully added." ,len(to_do_list), "tasks remaining."

def delete_task(to_do_list, taskdel):
  to_do_list.remove(taskdel)
  return "Task successfully deleted." ,len(to_do_list), "tasks remaining."
...
def move_task(to_do_list, from_index, to_index):
    ...
    return "Task", task, "successfully moved to", to_index
