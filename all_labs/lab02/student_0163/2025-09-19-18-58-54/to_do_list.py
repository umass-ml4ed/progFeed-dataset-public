...
def add_task(l, task):
  l.append(task)
  N=len(l)
  c="Task successfully added. "+str(N)+" tasks remaining."
  return c

def delete_task(l,task):
  l.remove(task)
  N=len(l)
  c="Task successfully deleted. "+str(N)+" tasks remaining."
  return c
...
def move_task(l,from_index,to_index):
  ...
  T=l.pop(from_index)
  l.insert(J,T)
  c="Task \'"+T+"\' successfully moved to index "+str(J)
  return c
