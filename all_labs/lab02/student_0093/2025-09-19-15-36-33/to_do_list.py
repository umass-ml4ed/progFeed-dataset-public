...
def add_task(to_do_list, task):
  ...
  n_tasks = str(len(to_do_list))
  return ("Task successfully added. " + n_tasks + " tasks remaining.")


def delete_task(to_do_list, task):
  to_do_list.remove(task)
  n_tasks = str(len(to_do_list))
  return ("Task successfully deleted. " + n_tasks + " tasks remaining.")
...
def move_task(to_do_list, from_index, to_index):
  ...
  return "Task " + task_moved + " successfully moved to index " + to_index
