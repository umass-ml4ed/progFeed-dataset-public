...
def add_task(list, task:str):
  list.append(task)
  print("Task successfully added.", len(list), "tasks remaining.")

def delete_task(list, task:str):
  list.pop(list.index(task))
  print("Task deleted successfully.", len(list), "tasks remaining.")

def move_task(list, from_index:int, to_index:int):
  moved_task = list[from_index]
  list.pop(from_index)
  list.insert(to_index, moved_task)
  print("Task", moved_task, "successfully moved to index", to_index)
