...
def add_task(to_do_list, add):
  to_do_list.append(add)
  l1= "Task successfully added. " + str(len(to_do_list)) + " tasks remaining."

  return l1

def delete_task(to_do_list, delete):
  to_do_list.remove(delete)
  l1= "Task successfully deleted. " + str(len(to_do_list)) + " tasks remaining."
  return l1
