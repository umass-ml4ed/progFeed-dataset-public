...
def add_task(list,string):
  list.append(string)
  return ("Task successfully added. " + str(len(list)) + " tasks remaining.")

def delete_task(list,string):
  list.remove(string)
  return ("Task successfully deleted. " + str(len(list)) + " tasks remaining.")

def move_task(list, from_index, to_index):
  moved_var = list[from_index]
  list.pop(from_index)
  list.insert(to_index,moved_var)
  return ("Task '" + str(moved_var) + "' successfully moved to index " + str(to_index))
