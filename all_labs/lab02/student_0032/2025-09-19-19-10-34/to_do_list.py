...
def add_task(list, string):
  list.append(string)
  length = len(list)  
  c = str("Task successfully added. ") + str(length) + str(" tasks remaining.")
  return c

def delete_task(list, string):
  list.remove(string)
  length = len(list)
  c = str("Task successfully deleted. ") + str(length) + str(" tasks remaining.")
  return c
   
def move_task(list, from_index, to_index):
  value = list.pop(from_index)
  list.insert(to_index, value)
  c = str("Task '") + str(value) + str("' successfully moved to index ") + str(to_index)
  return c
