...
def add_task(to_do_list, task):
    ...
    print str(' Task successfully added. ' + str(len(to_do_list)) + ' tasks remaining.')
    return to_do_list

def delete_task(to_do_list, task):
   to_do_list.remove(task)
   print str(' Task successfully deleted. ' + str(len(to_do_list)) + ' tasks remaining.')
   return to_do_list

def move_task(to_do_list, from_index, to_index):
   task = to_do_list.pop(from_index)
   to_do_list.insert(to_index, task)
   print str(' Task ' + "'" + task + "' successfully moved to index " + str(to_index) + ".")
   return to_do_list
