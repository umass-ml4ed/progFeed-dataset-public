...
def add_task(to_do_list, new_task):
  to_do_list.append(str(new_task))
  return "Task successfully added. " + str(len(to_do_list)) + " tasks remaining."
  # return to_do_list, new_task

def delete_task(to_do_list, new_task):
  to_do_list.remove(new_task)
  return "Task successfully deleted. " + str(len(to_do_list)) + " tasks remaining."

def move_task(to_do_list, from_index, to_index):
  y = to_do_list.pop(from_index)

  to_do_list.insert(to_index, y)
