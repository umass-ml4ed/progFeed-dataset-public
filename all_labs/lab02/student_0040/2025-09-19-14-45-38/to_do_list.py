...
def add_task(to_do_list, a):
  to_do_list.append(a)
  n = len(to_do_list)
  print("Task successfully added. "+str(n)+" tasks remaining.")


def delete_task(to_do_list, b):
  to_do_list.remove(b)
  n = len(to_do_list)
  print("Task successfully deleted. "+str(n)+" tasks remaining.")


def move_task(to_do_list, x, y):
  what = to_do_list[x]
  to_do_list.pop(x)
  to_do_list.insert(y, what)
  print("Task '"+str(what)+"' successfully moved to index "+str(y))
