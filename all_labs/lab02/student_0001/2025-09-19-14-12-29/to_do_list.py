...
def move_task(to_do_list: list, from_index: int, to_index: int):
  to_do_list[to_index] = to_do_list[from_index]
  return (f"Task '{to_do_list[from_index]}' succesfully moved to index {to_index}")
# ===== YOUR CODE ENDS HERE =====
...
# to_do_list = ["Buy groceries", "Clean the house", "Do laundry"]
# result = move_task(to_do_list, 1, 0)
# print(result)