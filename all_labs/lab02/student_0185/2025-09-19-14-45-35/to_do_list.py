...
def add_task(l: list, s: str):
  l.append(s)
  return (f"Task successfully added. {len(l)} tasks remaining.")
  
def delete_task(l: list, s: str):
  l.remove(s)
  return (f"Task successfully deleted. {len(l)} tasks remaining.")
