...
words = ('this', 'is', 'a', 'test', 'is', 'this', 'test', 'for', 'the', 'count', 'bigrams', 'function')
print("Expected: {('this', 'is'): 2, ('is', 'a'): 1, ('a', 'test'): 1, ('test', 'is'): 1, ('is', 'this'): 1, ('this', 'test'): 1, ('test', 'for'): 1, ('for', 'the'): 1, ('the', 'count'): 1, ('count', 'bigrams'): 1, ('bigrams', 'function'): 1}")
print(count_bigrams(words))
#Notes:
#print(words[0:2])
#print(words[1:3])
