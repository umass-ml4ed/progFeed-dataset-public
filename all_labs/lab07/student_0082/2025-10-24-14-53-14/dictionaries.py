...
def average_prices(prices):
    total_prices = {}
    total_number = {}
    for comodity, price in prices:
        if comodity in total_prices:
            total_prices[comodity] += price
            total_number[comodity] += 1
        else:
            total_prices[comodity] = price
            total_number[comodity] = 1
    average = {}
    for comodity in total_prices:
        average[comodity] = total_prices[comodity] / total_number[comodity]
    return average
