...
def get_names(first_names, last_names):
    """
    Takes two lists of strings representing first names and last names,
    ...
    Returns:
        list: A list of full names, where each name is a combination of a first name and a last name.
    """
    full_names = []
