...
def average_scores(scores):
    ...
    for student_scores in scores:
        ...
        # NOTE: You might want to add a check here for division by zero 
        # (if a student has 0 assignments), but based on typical lab 
        # structure, this is usually not an issue.
        if total_assignments > 0:
            student_average = total_score / total_assignments
            student_averages.append(student_average)
        # If total_assignments is 0, they would simply not have an average appended
