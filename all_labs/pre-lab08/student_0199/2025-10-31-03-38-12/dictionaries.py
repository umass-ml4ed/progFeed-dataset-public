...
def greet_user(users, user_id, default_lang = "en", default_age = 18):
    ...
    if age < 18 and language in greetings:
        return greetings[language]["child"]
    elif age < 18 and language not in greetings:
        return greetings["en"]["child"]
    elif age > 18 and language in greetings:
        return greetings[language]["adult"]
    else:
        return greetings["en"]["adult"]
