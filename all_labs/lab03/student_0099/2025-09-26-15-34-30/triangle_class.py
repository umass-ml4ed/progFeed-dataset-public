...
print(classify_by_edges(3, 4, 5))   
print(classify_by_edges(3, 3, 3))   
print(classify_by_edges(3, 3, 5))   
print(classify_by_edges(1, 2, 3))   
...
print(classify_by_angles(2, 3, 4))   
print(classify_by_angles(3, 3, 5))   
print(classify_by_angles(1, 2, 3))   
