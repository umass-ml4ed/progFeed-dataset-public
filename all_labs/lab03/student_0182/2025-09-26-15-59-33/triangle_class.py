...
def classify_by_angles(a,b,c):
    import math
    if float(a) + float(b) + float(c) <= float(2) * max(float(a),float(b),float(c)):
        return "invalid"
    else:
        if (float(a) ** float(2)) + (float(b) ** float(2)) + (float(c) ** float(2)) == float(2) * (max(float(a),float(b),float(c)) ** float(2)):
            return "right"
        else:
            if (float(a) ** float(2)) + (float(b) ** float(2)) + (float(c) ** float(2)) < float(2) * (max(float(a),float(b),float(c)) ** float(2)):
                return "obtuse"
